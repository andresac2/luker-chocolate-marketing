...
class Home extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="home">
        <HelmetComponent title={t('home.titulo_seo')} keywords={t('home.keywords')} titleOg={t('home.titulo_protocolo_opengraph')} description={t('home.meta_descripcion')} descriptionOg={t('home.descripcion_opengraph')} imageOG={t('home.imagen_open_graph.url')} />
        ...
        <div className="home-buttons">
          ...
          <a 
            className="home-buttons-blog" 
            href={`https://info.lukercacao.com/luker/${i18n.language == 'es'?'Sostenibilidad/es/':'Sustainability/en/'}`}> 
            {t('buttons.get-full-report')} 
          </a>
        </div>
