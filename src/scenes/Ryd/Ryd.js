  ...
  render() {
    ...
    return (
      <div className="ryd-component">
        <HelmetComponent title={t('ryd.titulo_seo')} keywords={t('ryd.keywords')} titleOg={t('ryd.titulo_protocolo_opengraph')} description={t('ryd.meta_descripcion')} descriptionOg={t('ryd.descripcion_opengraph')} cover={t('ryd.imagen_open_graph.url')} url={'ideas-trends'} />
        {!selectTab &&
