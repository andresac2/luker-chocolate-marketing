...
function Customer(props) {
  ...
  return (
    <div className='customer-component'>
      <HelmetComponent title={t('our-clients.titulo_seo')} keywords={t('our-clients.keywords')} titleOg={t('our-clients.titulo_protocolo_opengraph')} description={t('our-clients.meta_descripcion')} descriptionOg={t('our-clients.descripcion_opengraph')} />
